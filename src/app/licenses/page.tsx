    ...
    <section className="section"><div className="wrap">
      <div className="search-panel">
        ...
        <form className="search" method="get">
          ...
          <label className="sr-only" htmlFor="license-trade">Filter by trade</label><select id="license-trade" name="trade" defaultValue={trade ?? ""}><option value="">All trades</option>{[{ value: "electrical", label: "Electrical" }, { value: "general-contractor", label: "General contractor" }, { value: "hvac", label: "HVAC" }, { value: "plumbing", label: "Plumbing" }, { value: "roofing", label: "Roofing" }, { value: "swimming-pool", label: "Swimming pool" }, { value: "utility", label: "Underground utility" }].map((item) => <option key={item.value} value={item.value}>{item.label}</option>)}</select>
